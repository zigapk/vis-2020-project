...
print(','.join(
    ['exercise_id', 'question_guid', 'rating', 'topic', 'difficulty', 'average_result', 'questions_in_exercise', 'exercise_id_int']))
for exercise_id, exercise_data in exercises.items():
    ...
    for question in exercise_data['questions']:
        ...
        print(','.join([exercise_id, guid, str(rating), str(topic), str(difficulty), str(avg),
                        str(questions_in_exercise), str(question['exercise_id_int'])]))
